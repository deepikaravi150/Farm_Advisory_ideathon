  ...
  if (loading) return (
    <section className="py-12 px-4 bg-earth-50">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-earth-800 mb-6 text-center">Government Schemes</h2>
  ...
  if (!schemes.length) return (
    <section className="py-12 px-4 bg-earth-50">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-2xl font-bold text-earth-800 mb-4">Government Schemes</h2>
        <p className="text-gray-500">Schemes will appear here once seeded.</p>
      </div>
    </section>
  );
    ...
    <section className="py-12 px-4 bg-earth-50">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-earth-800 mb-6 text-center flex items-center justify-center gap-2">
          <IndianRupee className="w-6 h-6 text-earth-600" /> Government Schemes for Farmers
        </h2>
